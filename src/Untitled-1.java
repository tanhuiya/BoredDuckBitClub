...
contract Stake_v1 {
    ...
    function setWhitelistTokenAmount(uint256 _amount) public onlyOwner {
    ...
    function whitelistClaim() public onlyOwner() {
        require(whitelist[msg.sender], "not able to claim");
        whitelist[msg.sender] = false;
        erc20.transfer(address(msg.sender), whitelistTokenAmount);
    }

    function setWhitelist(address[] memory addrs) public onlyOwner {
